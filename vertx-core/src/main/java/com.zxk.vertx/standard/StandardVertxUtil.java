package com.zxk.vertx.standard;

import com.zxk.vertx.util.NetworkUtil;
import com.zxk.vertx.util.ObjectUtils;
...
public class StandardVertxUtil {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(StandardVertxUtil.class);
    ...
    public static Vertx setClusterVertx(Vertx vertx) {
        ObjectUtils.requireNonNull(vertx, "Need to cluster the vertx object is empty.");
    ...
    public static Vertx getStandardVertx() {
        ObjectUtils.requireNonNull(standardVertx, "Please perform vertx initialization, otherwise will block the subsequent operations.");
        return standardVertx;
    }
